...
The effect of so high a number that it eclipses the contribution to human cost of the rest of the phenomena, so we'll show a 2nd plot **WITHOUT** data for tornadoes.
